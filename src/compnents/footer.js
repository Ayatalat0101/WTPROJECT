...
import logo from '../compnents/images/GIRLS__1_-removebg-preview2.png'
function Footer() {
  return (
    <div className={styles.footer}>
      <footer >
        <div className={styles.divfooter1}>
          <img className={styles.footerimag} src={logo} />
          <p>
            <span>
              إحدى الشركات الناشئة لتقديم الخدمات البرمجية والتصميم والتسويق عبر
              الإنترنت
            </span>
          </p>
